...
export const basic = () => {
	...
	},
	{
	    ...
	    "page": "login",
	    "label": "Sign-In",
	    "url": "<wc-include href='http://links.melify.com/tk/lib/components/w/html/parts/pager/login.html'></wc-include>"
	},
	{
	    "cache": "true",
	    "page": "cart",
	...
	<div id="wc">
		...
		<div className="row">
			...
			<MTKpager id="my-pager" env="dev" class="wc-maximize" cfg={pagerData}></MTKpager>
		    </div>
		</div>
	    </div>
	</div>
