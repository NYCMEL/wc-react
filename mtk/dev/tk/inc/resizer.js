...
(function(o, y, O) {
    ...
    fa(function(a) {
        ...
        var ta = a('<style type="text/css" media="print">'),
            ...
            ia = a('<li class="info">'),
            Ma = a('<ul id="extras">'),
            Z = a('<a title="Animate Viewport">').text(""),
            ...
            E = a('<a data-icon="hint" title="XXXXXXXXXXXXXXXXX">'),
        ...
        C.append(a('<div class="inner">').append(a('<p class="well">').append(La).append(pa)).append(X).append(a('<p class="muted">').html())).appendTo(F);
